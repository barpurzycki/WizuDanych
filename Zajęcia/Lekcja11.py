...
#przekazujemy dwa wektory wartości, najpierw dla wektora x, następnei dla wektora y
...
#każdorazoro podając niezbędne wartości: wartości dla osix, wartości dla osi y, styl wykresu, ...
...
#aby w ten sposób prekazać parametry wykresu należy dodać niezbędny parametr data, który zawiera dane dostępne poprzez etykiety
